...
export default class Chat extends Component {
  ...
  render() {
    ...
    if (!isLogin) {
      return (<div className="login shadow-sm">
      <h4>Пожалуйста представьтесь</h4>
      <input className="form-control" value={currentUser} onChange={this.changeName} placeholder="Введите Ваше имя" type="text" />
      <button className="btn btn-primary" onClick={this.inputName}>Войти</button>
      </div>
      )
    }
    return (
      <div className="chat">
        ...
        <Send value={message} onChange={this.changeMessage} onSend={this.sendMessage} />
